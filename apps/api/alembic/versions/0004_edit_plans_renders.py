...
def upgrade() -> None:
    ...
    op.create_index('ix_edit_plans_project_created', 'edit_plans', ['project_id', 'created_at'], unique=False)
    ...
    sa.Column('status', sa.Enum('pending', 'rendering', 'ready', 'failed', 'cancelled', name='renderstatus', native_enum=False, length=16), nullable=False),
